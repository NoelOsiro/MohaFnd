                    ...
                    <div className="col-lg-6">
                        <div className="card2 card border-0 px-4 py-5">
                            ...
                            <div className="row px-3">
                                ...
                                <input className="mb-4" type="text" name="email" placeholder="Enter a valid email address" value={email}
                                    onChange={(e) => setEmail(e.target.value)} />
                            </div>
                            <div className="row px-3">
                                <label className="mb-1"><h6 className="mb-0 text-sm">Password</h6></label>
                                <input type="password" name="password" placeholder="Enter password" value={email}
                            ...
                            <div className="row mb-3 px-3">
                                <button type="submit" className="btn btn-blue text-center" onClick={handleLogin}>Login</button>
                            </div>
                            <div className="row mb-4 px-3">
