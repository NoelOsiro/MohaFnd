...
export default function StaffRosterCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setOn_duty(initialValues.on_duty);
    setErrors({});
  };
  const validations = {
    start_date: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new StaffRoster(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "StaffRosterCreateForm")}
      {...rest}
    >
      <TextField
        label="Start date"
