...
import { Appointments, AppointmentStatusEnum, Patient, Tasks } from '../models';
...
export const getAppointmentsThisWeek = async () => {
  try {
    ...
    const appointmentsThisWeek = await DataStore.query(Appointments, (appointment) =>
    ...
    return appointmentsWithPatientNames as Appointment[]; // Explicitly cast to Appointment[]
  } catch (error) {
